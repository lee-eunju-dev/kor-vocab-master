    ...
    >
      <defs>
        ...
        <filter id={shadowId} x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="0" dy="3" stdDeviation="2.4" floodColor="#3B2A2A" floodOpacity="0.22" />
        </filter>
      </defs>
      ...
      <g filter={`url(#${shadowId})`}>
        ...
        {/* 왼쪽 눈 */}
        {leftEyeClosed ? (
          <path d="M30 52 C34 46 40 46 44 52" stroke="#3B2A2A" strokeWidth="3.4" fill="none" strokeLinecap="round" />
        ) : (
          <g>
            <ellipse cx="37" cy="53" rx="4.2" ry="5.2" fill="#3B2A2A" />
        ...
        {/* 오른쪽 눈 */}
        {rightEyeClosed ? (
          <path d="M56 52 C60 46 66 46 70 52" stroke="#3B2A2A" strokeWidth="3.4" fill="none" strokeLinecap="round" />
        ) : (
          <g>
            <ellipse cx="63" cy="53" rx="4.2" ry="5.2" fill="#3B2A2A" />
        ...
        {isSmiling ? (
          ...
          <path d="M46 68 C48 70 52 70 54 68" stroke="#3B2A2A" strokeWidth="2.4" fill="none" strokeLinecap="round" />
        )}

        {/* 수염 */}
        <path d="M6 54 C13 55 18 56 25 58" stroke="#3B2A2A" strokeWidth="1.8" fill="none" strokeLinecap="round" />
        <path d="M6 66 C13 64 18 63 25 62" stroke="#3B2A2A" strokeWidth="1.8" fill="none" strokeLinecap="round" />
        <path d="M94 54 C87 55 82 56 75 58" stroke="#3B2A2A" strokeWidth="1.8" fill="none" strokeLinecap="round" />
        <path d="M94 66 C87 64 82 63 75 62" stroke="#3B2A2A" strokeWidth="1.8" fill="none" strokeLinecap="round" />
        ...
        {showCrown && (
          <g>
            <path
              ...
              strokeLinejoin="round"
            />
            <circle cx="50" cy="16" r="3.4" fill="#FF8FB3" stroke="#3B2A2A" strokeWidth="1.4" />
